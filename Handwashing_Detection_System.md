...
At this stage, the most important thing is not only modifying the APK, but clearly defining what counts as “valid handwashing”. Otherwise, even if the model detects actions, we would not know how to evaluate them.

---

## 1. Defining a Valid Handwashing Process

We initially planned to follow the standard 7-step handwashing method:
...
However, during development, instead of using complex medical standards，we simplified the system to focus on three core actions to improve stability and make real-time recognition more reliable.

---

We focus on three key actions:

- Palm-to-palm rubbing  
- Back-of-hand cleaning  
- Finger cleaning  

These actions capture the most important hygiene behaviors while keeping the recognition system simple and reliable.
...
- The following actions must be included:
  ...
  - Back-of-hand cleaning
  - Finger cleaning
- Each action must last at least 5 seconds
